...
#source('/Users/s1687811/Documents/GitHub/covid19/WHO_report/script/WHO_report.analysis.R')
...
load(paste0('/Users/s1687811/Documents/GitHub/covid19/WHO_report/output/WHO_report_analysis_', as.character(today), '.RData'))
...
knitr::include_graphics("/Users/s1687811/Documents/GitHub/covid19/WHO_report/input_files/Map_WHO_Countries.png")
```
...
As of `r format(today, "%d/%m/%Y")`, each panel below respectively shows:  
&nbsp;
 
* Top-left: cumulated reported cases.  
* Top-right: cumulated reported cases per 10,000 population on a log10 scale.  
* Bottom-left: cumulated reported deaths.  
* Bottom-right: cumulated reported deaths per 10,000 population on a log10 scale.  
...
## Algeria
```{r, echo=FALSE,  fig.height = 8, fig.width = 8, fig.fullwidth = TRUE}
