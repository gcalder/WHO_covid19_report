...
* Top graph: SARS-CoV-2 genomes available on GISAID by collection date. 6 genomes from the Democratic Republic of the Congo, 110 genomes from Kenya and 1 genome from Nigeria are removed due to incomplete collection dates.
